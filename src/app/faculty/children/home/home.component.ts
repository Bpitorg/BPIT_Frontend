...
export class FacultyHomeComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    // this.facultyhome1 = this.initForm1(); by me
  }
  ...
  UserSubmit() {
    ...
    formData.append('designation', this.facultyhome.value['designation']);
    formData.append('Qualification', this.facultyhome.value['Qualification']);
    formData.append('Experience', this.facultyhome.value['Experience']);
    formData.append('specialization', this.facultyhome.value['specialization']);
    formData.append('nation_Publications', this.facultyhome.value['nation_Publications']);
    formData.append('international_publication', this.facultyhome.value['international_publication']);
    formData.append('date_of_joining', this.facultyhome.value['date_of_joining']);
    formData.append('faculty_publication_url', this.facultyhome.value['faculty_publication_url']);
    // formData.append('branch', this.branch);
